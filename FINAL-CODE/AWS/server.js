...
const corsOptions = {
  origin: 'http://3.29.102.4:3000', // Replace with the actual IP/hostname of your frontend
  methods: ['GET', 'POST'],
...
// MongoDB Connection
const MONGO_URI = 'mongodb://localhost:27017/geofence-db'; // Ensure this points to your MongoDB instance
...
const PORT = 3000;
server.listen(PORT, () => {
  console.log(`Server running on http://3.29.102.4:${PORT}`);
});